        ...
        <div class="col-md-8 offset-md-2">
            <div class="card shadow-sm border-0">
                <div class="card-body p-4">
                    ...
                    <p class="text-muted mb-4">Buat pocket baru untuk mengelola uang Anda</p>

                    @if ($errors->any())
                        <div class="alert alert-danger alert-dismissible fade show" role="alert">
                            <i class="bi bi-exclamation-circle me-2"></i>
                            <strong>Gagal membuat pocket!</strong>
                            <ul class="mb-0 mt-2">
                    ...
                    <form action="{{ route('pocket.store') }}" method="POST">
                                ...
                                @foreach ($colors as $colorCode => $colorName)
                                    <label class="color-option">
                                        <input 
                                            ...
                                            {{ old('warna', '#667eea') == $colorCode ? 'checked' : '' }}
                                        >
                        ...
                        <div class="d-flex gap-2">
                            ...
                            <button type="submit" class="btn btn-primary flex-grow-1">
                                <i class="bi bi-check-circle me-2"></i>Buat Pocket
                            </button>
                        </div>
                    </form>
                </div>
